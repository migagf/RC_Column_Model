...
def get_residual(ModelParams, test_data, show_plots=False):
    ...
    # Sub-sample force_exp and force_model to 500 points each
    force_model_int = interpolator(force_model, 500) / peak_force
    force_exp_int = interpolator(force_exp, 500) / peak_force
