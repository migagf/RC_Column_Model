...
(1) Run the 01_get_data_peer.py file to download and process the data from the Peer Performance Database.
...
(2) Run the 02_create_data_matrix.py code to compute the non-dimensional parameters for each column. This will generate two files:
...
(3) Run the 03_surrogate_training.ipynb file
    This file will create the training files for quoFEM to generate surrogate models.
    Check the possible configurations in the file.
