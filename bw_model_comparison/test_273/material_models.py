...
class bw_material():
    ...
    def set_trial_state(self, tstrain):
        ...
        while np.abs(Tzold - Tznew) > 1.0e-6 and count < maxiter:
            ...
            count += 1
            if count == maxiter:
                print("WARNING -- MAX ITERATIONS REACHED IN MATERIAL MODEL")
...
# :::
# Degrading Bou-Wen without changes in rs
# :::
class deg_bw_material_mod_1():
    '''
    This is a degrading bouc wen material class
    Modified to include reloading stiffness
    ...
    def set_trial_state(self, tstrain):
        ...
        emax = self.cstate["emax"]
        # rs = self.cstate["rs"]
        rs = rsmax # Instead of udpating rs, keep it constant
